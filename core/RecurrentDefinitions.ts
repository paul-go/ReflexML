...
declare function on<K extends keyof HTMLElementEventMap>(
	events: K | K[],
	callback: (ev: HTMLElementEventMap[K], e: HTMLElement) => ReflexML.Atom,
...
declare function on<T>(
	...
	renderFn: (item: T, index: number) => ReflexML.Atom
): Reflex.Recurrent;
...
declare function on(
	forces: (() => void) | (() => void)[],
	callback: (e: HTMLElement) => ReflexML.Atom
): Reflex.Recurrent;
...
declare function on<A1>(
	...
	callback: (a1: A1, e: HTMLElement) => ReflexML.Atom
): Reflex.Recurrent<[A1]>;
...
declare function on<A1, A2>(
	...
	callback: (a1: A1, a2: A2, e: HTMLElement) => ReflexML.Atom
...
declare function on<A1, A2, A3>(
	...
	callback: (a1: A1, a2: A2, a3: A3, e: HTMLElement) => ReflexML.Atom
...
declare function on<A1, A2, A3, A4>(
	...
	callback: (a1: A1, a2: A2, a3: A3, a4: A4, e: HTMLElement) => ReflexML.Atom
...
declare function on<A1, A2, A3, A4, A5>(
	...
	callback: (a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, e: HTMLElement) => ReflexML.Atom
...
declare function on<T>(
	...
	callback: (now: T, was: T, e: HTMLElement) => ReflexML.Atom
): Reflex.Recurrent;
...
declare function on(
	...
	callback: (kind: Reflex.mutation, node: HTMLElement | Text) => ReflexML.Atom
): Reflex.Recurrent;
...
declare function on(
	...
	callback: (text: Text) => ReflexML.Atom
): Reflex.Recurrent;
...
declare function on<A extends any[]>(
	callback: (e: HTMLElement, ...args: A) => ReflexML.Atom,
	...args: A
): Reflex.Recurrent;
